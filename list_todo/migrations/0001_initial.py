# Generated by Django 3.1.1 on 2020-09-02 14:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='list_todo.room', verbose_name='Комната чата')),
